            ...
            <p class="text-inverse">Lorem ipsum dolor sit amet, consectetur adipisici eli.</p>
                ...
                <form onsubmit="addIngredient();return false;"><div class="text-center">
                  <div id="the-basics" class="row">
                    <div class="col-md-11"><input class="typeahead fullwidth" type="text" id="input" placeholder="Ingredient" size="50" /></div>
                    <div class="col-md-1"><input type="submit" class="btn btn-secondary fullwidth" value="เพิ่ม" /></div>
                  </div>
                  </div>
